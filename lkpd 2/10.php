...
// Menghitung jumlah jawaban benar dan salah dari array $hasil
foreach ($hasil as $item) {
  if ($item["status"] == "Benar") {
      $jumlahBenar++;  // Tambah jumlahBenar jika status adalah "Benar"
  } else {
      $jumlahSalah++;  // Tambah jumlahSalah jika status bukan "Benar"
  }
}
